...
public class TipoMovimento  implements java.io.Serializable {
    ...
    /**
     * Gets the id_tipo_movimento value for this TipoMovimento.
     * 
    ...
    /**
     * Sets the id_tipo_movimento value for this TipoMovimento.
     * 
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://ctr/", "tipoMovimento"));
